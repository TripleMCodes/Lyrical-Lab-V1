...
class LLSearchEngine:
    ...
    def index(self, docs: List[LyricDoc]):
        ...
        texts = [d.title + " " + d.text for d in docs] # title boost
    ...
    def search(self, query: str, top_k: int = 10) -> List[Dict]:
        scores = self._tfidf_scores(query=query)
